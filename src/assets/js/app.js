...
const menu_links_icon = Array.from(document.querySelectorAll('.menu-link-icon'));


/*--=========== ANIMATION MENU ============- */
const tl_menu = gsap.timeline({ paused: true });
tl_menu
.from(".menu blockquote", {
  opacity: 0,
  y: -100,
  x: -100,
  filter: 'blur(32px)',
    ...
    .from(".text6-3d", {
        ...
        onStart: function(){
            gsap.to(".square-animation", {
                ...
                scale: 1,
                rotate: 0,
                transform: 'translate(-50%, -50%) rotateX(160deg) rotateY(30deg) rotateZ(5deg)',
                scrollTrigger:{
                    trigger: '.text6-3d',
                    start: 'center 50%',
                    end: 'center 00%',
    ...
    .from(".text7-3d", {
        ...
        onStart: function(){
            gsap.to(".square-animation", {
                ...
                scale: 0,
                rotate: 0,
                transform: 'translate(-50%, -50%) rotateX(240deg) rotateY(-60deg) rotateZ(20deg)',
                scrollTrigger:{
                    trigger: '.text7-3d',
                    start: 'center 50%',
                    end: 'center 00%',
